...
using a genetic algorithm to breeed super rats in a lab
'''
import time
import random
import statistics
...
def select(population, to_retain, num_of_males, num_of_females):
	...
	selected_females = females[-num_of_females:]
	selected_males = males[-num_of_males:]
...
def main():
	...
	while popl_fitness < 1 and generations < GENERATION_LIMIT:
		selected_males, selected_females = select(parents, NUM_RATS, num_of_males, num_of_females)
