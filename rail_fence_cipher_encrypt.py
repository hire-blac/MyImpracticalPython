...
Encrypted: BYEOA NPTTE UMRMI EOSOS
'''
#=====================================================================
#USER INPUT:
...
def prep_plaintext(plaintext):
	'''remove spaces and leading/trailing whitespaces'''
...
def encrypt(rails):
	'''Split letters in ciphertext into chuncks of 5 and join to make string'''
